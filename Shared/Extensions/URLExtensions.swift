...
extension URL {
  ...
  public var baseDomain: String? {
    ...
    return URLHelper.shared.publicSuffix(fromHost: host, withAdditionalParts: 1)
  }
  ...
  public var publicSuffix: String? {
    return host.flatMap { URLHelper.shared.publicSuffix(fromHost: $0, withAdditionalParts: 0) }
  }
